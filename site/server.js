...
const PORT = process.env.PORT || 3000;  // Utiliser le port fourni par Railway
...
// Lancer le serveur sur le bon port et écouter sur toutes les interfaces
app.listen(PORT, '0.0.0.0', () => {  // Ecouter sur toutes les interfaces réseau
